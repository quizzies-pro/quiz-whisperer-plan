...
const VSLStep = React.memo(({ step, onNext }: VSLStepProps) => {
  ...
  return (
  <div className={`h-full w-full relative flex items-start justify-center px-4 pt-12 sm:pt-[70px] pb-[100px] sm:pb-[120px] scrollbar-none overflow-y-auto ${!showCTA ? 'max-sm:overflow-hidden' : ''}`}>
